...
import com.wspereira.cursomc.domain.ItemPedido;
...
import com.wspereira.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		ItemPedido ip1 = new ItemPedido(pdd1, p1, 0.00, 1, 4500.00);
		ItemPedido ip2 = new ItemPedido(pdd1, p2, 0.00, 2, 150.00);
		ItemPedido ip3 = new ItemPedido(pdd2, p3, 10.00, 2, 80.00);
		
		
		pdd1.getItens().addAll(Arrays.asList(ip1, ip2));
		pdd2.getItens().addAll(Arrays.asList(ip3));
